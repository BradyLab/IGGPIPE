...
*Requirements*
~~~~~~~~~~~~~~
* The installation instructions are for 64-bit Mac OSX. It has also been tested on
64-bit Linux.  It will not work on 32-bit Windows.  It has not been tested on
64-bit Windows.
