...
We used version 6.4, although later versions should work fine.
...
Now the Jellyfish program must be compiled into an application and then installed
on your computer.
...
+
--
To compile and build Jellyfish on OSX, Linux, or Windows/Cygwin:
