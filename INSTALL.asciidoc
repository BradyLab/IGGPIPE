...
directory, which is the default for the R installer, an error occured with the
...
expected result, which is in subdirectory goodTest:
  ...
  diff outTestHP11/MarkersOverlapping_*.tsv goodTest/
...
LCRs_ file:
  ...
  diff outTestHP11/LCRs_*.tsv goodTest/
