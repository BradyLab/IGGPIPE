...
|l. make PARAMS=myFilename getDNAseqsForPrimers|IndelGroupsOverlapping_*.dnaseqs
...
|q. make PARAMS=myFilename getDNAseqsForIndelsSNPs|*.withseqs.tsv
|r. make PARAMS=myFilename IndelsSNPs|*.indels.tsv, *.snps.tsv
|s. make PARAMS=myFilename plotIndels|*.indels.pdf
|t. Rscript code/R/dotplot.R dotplot.template|LCRs_*.dotplot.png
|u. Rscript code/R/annotateFile.R annotate.template|MarkersAnnotated_*.tsv
|v. Rscript code/R/annotateFile.R annotate/HP11_isInNearColumn.markers|MarkersAnnotated_WithInNearFeatures_*.indels.tsv
|w. Rscript code/R/annotateFile.R annotate/HP11_to_gff3.markers|MarkersAnnotated_GFF3_*.gff3
|===================================================
