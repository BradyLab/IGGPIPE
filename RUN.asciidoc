...
take two days to finish running all Indel Groups through Primer3. This is
where extra memory can be helpful.
...
take two days 'per genome' to finish running all primer pairs through e-PCR. This is
where extra memory can be helpful.
