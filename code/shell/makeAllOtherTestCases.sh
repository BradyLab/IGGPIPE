...
make PARAMS=allParameters/allParameters.AtCL plotIndels | tee logFiles/makeLog_CL_IndelsSNPs.txt
...
make PARAMS=allParameters/allParameters.HPT plotIndels | tee logFiles/makeLog_HPT_IndelsSNPs.txt
...
make PARAMS=allParameters/allParameters.HPT2.3 plotIndels | tee logFiles/makeLog_HPT2.3_IndelsSNPs.txt
...
make PARAMS=allParameters/allParameters.Ta3 plotIndels | tee logFiles/makeLog_Ta3_IndelsSNPs.txt
